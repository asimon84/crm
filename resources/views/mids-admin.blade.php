...
@section('css')
    ...
    <link href="{{ asset('public/css/mids-admin.css') }}" rel="stylesheet">
@endsection
...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">MIDs Admin</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-functions">
                            <div class="btns-left">
                                @if (in_array('add_mids', $permissions))
                        ...
                        <div class="tab-block mb15 mt15">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li id="tab2li"><a href="#tab2" id="tab2lia" data-toggle="tab">MIDs</a></li>
                            </ul>
                            <div class="tab-content">
                                    ...
                                    <div class="table-functions">
                                        ...
                                        <div class="btns-right">
                                            <a href="#tab2" data-toggle="tab" class="btn btn-success margin10" id="view_all_button"><span
                                                        class="fa fa-eye"></span> View All MIDs
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div id="tab2" class="tab-pane">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="midsTable">
                                        <thead>
                                        <tr>
                                            <th>MID ID</th>
                                            <th>Client Name</th>
...
@section('js')
    ...
    <script src="{{ asset('public/js/mids-admin.js') }}"></script>
